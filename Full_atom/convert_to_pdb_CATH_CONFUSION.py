...
target_pre_ls = ['1fzcB01', '4na1B02', '2m9hA00', '1i16A00', '2miqA00', '3c0dA00', '4cs9A00', '2vsgA02', '1i1jB00', '3cnqP00']
target_conf_ls = [i+'_confuse' for i in target_pre_ls]
target_ls = target_pre_ls + target_conf_ls
...
for target in target_ls:
    ...
    pdb_name = "/home/rotation3/complex-coor-pred/plot/CONFUSION/" + target + ".pdb"
