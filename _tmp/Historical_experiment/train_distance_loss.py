...
# function: 先将预测出的 4L3 , 分别计算计算Distance Loss
# 经过验证，这种方法不可行，网络基本无法收敛
# Author: Jun Li
...
for epoch in range(num_epochs):
    ...
    for index in seed_random_ls:
        ...
        pred_coor = confused_coor    # pred_coor [4,L,3]
        label_coor = full_label_coor[:,0,:,:]
        label_coor = label_coor.to(device)
        label_coor = torch.tile(label_coor,(4,1,1))
