...
if __name__ == "__main__":
    ...
    train_ds1 = MyData(train_data_path, xyz_path, sorted_train_file, part=0, train_mode=True)
    train_ds2 = MyData(train_data_path, xyz_path, sorted_train_file, part=1, train_mode=True)
    train_ds3 = MyData(train_data_path, xyz_path, sorted_train_file, part=2, train_mode=True)
    train_ds4 = MyData(train_data_path, xyz_path, sorted_train_file, part=3, train_mode=True)
